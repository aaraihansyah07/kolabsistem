	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
					...
					<form method="POST" action="#" style="width: 100%; margin: 0 auto; background-color: #f0f0f0; padding: 20px; border-radius: 8px;">
						...
						<div style="display: flex; flex-wrap: wrap; justify-content: space-between; margin-bottom: 20px;">
							...
							<div style="flex: 1; margin-right: 10px; margin-bottom: 10px;">
								<label for="jarak-dari" style="font-size: 16px; color: #333; display: block; margin-bottom: 5px;">Jarak:</label>
								<div style="display: flex; justify-content: space-between;">
									<input id="jarak-dari" type="number" placeholder="0" style="width: 48%; padding: 8px; font-size: 14px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
									<span style="align-self: center;">-</span>
									<input id="jarak-sampai" type="number" placeholder="1000" style="width: 48%; padding: 8px; font-size: 14px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
								</div>
							</div>
            ...
            <div class="row isotope-grid">
				...
				AND upper(k.nama_kosan) like upper('%$nama_kos_cari%')";
                $hasil = $db->query($sql);
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            ...
                            <form method="post" action="ruangan_kosan_view.php?rk=<?php echo $uuidruangankosan;?>">
