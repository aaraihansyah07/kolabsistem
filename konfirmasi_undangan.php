...
<html lang="en">
<head>
	<title>Konfirmasi Undangan Kolaborasi</title>
	<meta charset="UTF-8">
...
<body>
	...
	<section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
			<a href='riwayat_add_fav.php'><button class="btn btn-primary ms-auto"><i class="fa-solid fa-arrow-left"></i> Kembali</button></a>											
			
            <h3 class="ltext-106 cl5 txt-center">
				Konfirmasi Undangan Kolaborasi
			</h3>
            <form class="w-full" method="post" action="konfirmasi_undangan_proses.php" enctype="multipart/form-data">
                <div class="flex-w flex-m p-t-50 p-b-23">
                </div>
                <input id="name" type="text" name="uuidporto" value="<?php echo $uuidporto;?>" hidden/>
                <?php
                    $sql = "SELECT u.role_id, u.nama_perusahaan, jk.nama_jenis_kerjasama, uk.keterangan ket_kolab, uuiduserpengundang, uuiduserdiundang, id_undangan, uk.keterangan, fname, nama_univ, nama_fakultas, nama_prodi, angkatan
                    from f_undangan_kerjasama uk
                    left join d_jenis_kerjasama jk on jk.id_jenis_kerjasama = uk.id_jenis_kerjasama
                    left join user_pengguna u on u.uuiduser = uk.uuiduserpengundang
                    ...
                    if ($baris['role_id'] == 1) {
                        $caption = $baris['fname']. " (Mahasiswa Angkatan ".$baris['angkatan'].")";
                    }
                    else if ($baris['role_id'] == 2) {
                        $caption = $baris['fname']. " (Dosen)";
                    }
                    else if ($baris['role_id'] == 3) {
                        $caption = $baris['fname']. " (Pencari Talent)";
                    } 
                ?>
                <input id="name" type="text" name="uuiduserdiundang" value="<?php echo $uuiduser;?>" hidden/>
                <input id="name" type="text" name="id_undangan" value="<?php echo $id_undangan;?>" hidden/>
                <input id="name" type="text" name="uuiduserpengundang" value="<?php echo $baris['uuiduserpengundang'];?>" hidden/>
				<div class="row p-b-25">
                    <div class="col-sm-4 p-b-5">
						<label class="stext-102 cl3" for="review">Nama Pengundang</label>
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
							<input placeholder="Cth : Animasi 3d" value="<?php echo $caption;?>" class="size-111 bor8 stext-102 cl2 p-lr-20" id="name" type="text" name="fname" disabled>
						</div>
					</div>

                    <div class="col-sm-4 p-b-5">
						<label class="stext-102 cl3" for="review">Jenis Undangan Kolaborasi</label>
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
							<input value="<?php echo $baris['nama_jenis_kerjasama'];?>" class="size-111 bor8 stext-102 cl2 p-lr-20" id="name" type="text" name="fname" disabled>
						</div>
					</div>

                    <div class="col-sm-4 p-b-5">
						<label class="stext-102 cl3" for="review">Asal perusahaan</label>
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
							<input value="<?php echo $baris['nama_perusahaan'];?>" class="size-111 bor8 stext-102 cl2 p-lr-20" id="name" type="text" name="angkatan" disabled>
						</div>
					</div>

                    <div class="col-sm-4 p-b-5">
						<label class="stext-102 cl3" for="review">Asal Universitas</label>
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                    ...
                    <div class="col-sm-4 p-b-5">
						<label class="stext-102 cl3" for="review">Asal Fakultas</label>
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                    ...
                    <div class="col-sm-4 p-b-5">
						<label class="stext-102 cl3" for="review">Asal Prodi</label>
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                ...
                <div class="row p-b-15" style="margin-top:-2%">
                    <div class="col-12 p-b-5">
                        <label class="stext-102 cl3" for="review">Deskripsi Undangan</label>
                        <textarea required maxlength="300" class="size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10" style="height:150px" id="deskripsi" name="keterangan" disabled><?php echo $baris['ket_kolab'];?></textarea>
                    </div>
                </div>

                <div class="row p-b-25">
                    <div class="col-sm-6 p-b-5">
						<label class="stext-102 cl3" for="review">Konfirmasi</label>
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
							<select class="form-control" name="st_konfirmasi" required autofocus>
                    ...
                    <div class="col-sm-6 p-b-5">
						<label class="stext-102 cl3" for="review">Kontak yang diberikan kepada pengundang</label>
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
							<select class="form-control" name="kontak_yg_diberikan" required autofocus>
								<option value="">--Pilih--</option>
                                <option value="HP">Nomor HP</option>
                                <option value="EMAIL">Email</option>
								<option value="NOTHING">Tidak Berikan (Jika konfirmasi = Ditolak)</option>
							</select>
						<div class="dropDownSelect2"></div>
						</div>
					</div>	
                ...
                <button 
                    type="submit" 
                    name="konfirmasi"
                    onclick="return confirm('Konfirmasikan undangan kolaborasi ini ?')"
					class="btn btn-primary ms-auto">
					<i class="fa-solid fa-envelope"></i> Konfirmasi
                </button>
            </form>
		</div>
	</section>
