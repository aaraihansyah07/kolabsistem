...
<head>
	<title>Home</title>
	<style>
    #navbarDropdownUserImage {display:none}
...
<body>
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
            ...
            <div id="layoutSidenav_content" class="mt-10 w-full">
                <main>
                            ...
                            <div class="card-body">
                                <div class="datatable table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT h.uuidinvoice, to_char(h.tgl_pesanan, 'DD fmMonth YYYY') tgl_pesanan, h.nama_pemesan, h.alamat, h.username_pemesan, h.no_invoice, h.no_hp_pemesan, 
                                            case when (h.st_selesai_bayar = 'Y') then 'Sudah' else 'Belum' end STATUS_DIBAYAR, d.netto net, d.disc_amount jml_diskon, 
                                            d.amount jml_brutto, d.uuidproduk, p.nama_produk, p.kode_produk
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $baris['no_invoice'];?></td>
                                                    <td><?php echo $baris['tgl_pesanan'];?></td>
                                                    <td><?php echo $baris['nama_pemesan'];?></td>
                                                    <td><?php echo $baris['no_hp_pemesan'];?></td>
                                                    <td><?php echo $baris['kode_produk'];?></td>
                                                    <td><?php echo $baris['nama_produk'];?></td>
                                                    <td><?php echo number_format($baris['jml_brutto']);?></td>
                                                    <td><?php echo number_format($baris['jml_diskon']);?></td>
                                                    <td><?php echo number_format($baris['net']);?></td>
                                                    <td style='text-align:center'><div class="badge badge-primary badge-pill"><?php echo $baris['status_dibayar'];?></div></td>
                                                    <!-- <td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            document.querySelectorAll('.wishlist-btn').forEach(button => {
                button.addEventListener('click', () s=> toggleWishlist(button));
            });
