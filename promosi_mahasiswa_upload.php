...
<html lang="en">
<head>
	<title>Promosi Usaha Saya</title>
	<meta charset="UTF-8">
...
<body>
	...
	<?php
		$sql2 = "SELECT u.email, u.fname, u.st_active, v.nama_univ, f.nama_fakultas, p.nama_prodi, u.no_hp, u.st_follow_ig
    ...
    <section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
			<?php
				...
				// 	$tombol_upload = '';
				// }
                $tombol_kembali = "<a href='promosi_mahasiswa.php'><button class='btn btn-primary ms-auto'><i class='fa-solid fa-arrow-left'></i> Kembali</button></a>";
				
                if ($baris2['st_follow_ig'] == NULL) {
                    $tombol_upload = '';
                }
                else {
                     $tombol_upload = "<a href='promosi_mahasiswa_tambah.php'><button class='btn btn-success ms-auto'><i class='fa-solid fa-add'></i> Upload Promosi</button></a>";
                }        
			?>
			<div class="p-b-45">
				...
				<?php echo $tombol_kembali. "&nbsp". $tombol_upload;?>
			</div>
            <?php
                if ($baris2['st_follow_ig'] == NULL) {
            ?>
            <div style="text-align: justify; padding: 10px; background: #eebb57; border-radius: 4px;">
                ...
                <p>KolabSistem membuka ruang bagi mahasiswa untuk mempromosikan usaha, jasa, atau project pribadi secara gratis sebagai bentuk dukungan terhadap kolaborasi dan kemandirian mahasiswa.</p>
                <br>
                <p><b>Cara Unlock Fitur Promosi Gratis : </b></p>
                <p>1️⃣ Follow Instagram resmi KolabSistem : <a style='font-weight:bold; color:#194ca7; text-decoration:none' href='https://instagram.com/KolabSistem' target='_blank'>@KolabSistem</a></p>
                <p>2️⃣ Kirim screenshot bukti follow ke WhatsApp Admin KolabSistem hanya di : <a style='font-weight:bold; color:#194ca7; text-decoration:none' href='https://wa.me/6287753472949' target='_blank'>6287753472949</a></p>
                <p>3️⃣ Admin akan mengonfirmasi, lalu fitur upload promosi akan aktif</p>
                <br>
                <p><b>⚠️ Perhatian:</b></p>
                <p>Hati-hati terhadap penipuan yang mengatasnamakan KolabSistem. Kontak resmi hanya melalui:</p>
                <p>Whatsapp  : <a style='font-weight:bold; color:#194ca7; text-decoration:none' href='https://wa.me/6287753472949' target='_blank'>6287753472949</a></p>
                <p>Instagram : <a style='font-weight:bold; color:#194ca7; text-decoration:none' href='https://instagram.com/kolabsistem' target='_blank'>@KolabSistem</a></p>
                <br>
                <p>🤝 Terima kasih kepada seluruh Sobat KolabSistem yang telah mendukung melalui kepercayaan dan donasi. Dukunganmu membantu kami terus menyediakan platform gratis untuk mahasiswa di jenjang universitas.</p>
            </div>
            <?php
                }
            ?>
			...
			<div class="wrap-slick2">
				<div id="cards-container" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
					<?php
						...
						m.jml_klik, j.nama_kategori_promosi, f.nama_fakultas, p.nama_prodi, u.kode_fakultas, m.jml_klik
					...
					?>
					<form action="promosi_mahasiswa_edit.php" method="POST" class="card">
						<input type="hidden" name="kosan_id" value="1" />
						<button type="submit" value="<?php echo $id_promosi; ?>" name="to_detail">
						<div class="rounded-xl overflow-hidden shadow-md border bg-white hover:shadow-lg transition">
							...
							<div class="p-4">
								<p class="text-sm text-red-600 font-semibold mb-1" style="text-align:left">🏷️ <?php echo $baris['nama_kategori_promosi']. ' ('. $baris['jml_klik']. ' kali dikunjungi)';?></p>
