...
<body>
	...
	<section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
            ...
            <form class="w-full" method="post" action="modul_tambah_proses.php" enctype="multipart/form-data">
				...
				<div class="row p-b-25">
					<div class="col-sm-6 p-b-5">
						...
						<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
							<input placeholder="Cth : Animasi 3d" class="size-111 bor8 stext-102 cl2 p-lr-20" id="name" type="text" name="nama_porto" required>
						</div>
					</div>
							...
							<select class="form-control" name="id_kat_porto" required autofocus>
								...
								<?php
									...
									while ($barisb = $hasilb->fetch(PDO::FETCH_ASSOC)) {
										echo "<option value='".$barisb['id_kat_porto']."'>".$barisb['nama_kategori_porto']."</option>";
									}
								?>
							</select>
				...
				<div class="row p-b-25" style="margin-top:-2%">
					<div class="col-12 p-b-5">
						...
						<textarea class="size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10" 
							style="height:150px" 
							placeholder="Deskripsikan informasi penting portofolio" 
							id="deskripsi" 
				...
				<div class="w-full bg-white p-6 rounded-xl shadow-md">
					<h2 class="text-xl font-semibold mb-4">Upload Portofolio (PDF maks. 7 Mb)</h2>
				...
				<button type="submit" name="tambah"  class='btn btn-primary ms-auto' onclick="return confirm('Yakin ingin menyimpan portofolio ini?')" >
